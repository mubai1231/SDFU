...
from .resnetv2 import ResNet50, ResNet18, ResNet101, ResNet152
...
cifar_model_dict = {
    ...
    "ResNet101": (
        ResNet101,
        cifar100_model_prefix + "ResNet101_vanilla/ckpt_epoch_240.pth",
    ),
    "ResNet152": (
        ResNet152, None
    ),
    ...
    "ShuffleV2": (
        ShuffleV2,
        cifar100_model_prefix + "shuv2_vanilla/ckpt_epoch_240.pth"
    ),
    "VPTResNet18": (VPTResNet18, None),
    "VPTResNet34": (VPTResNet34, None),
    "VPTResNet50": (
        VPTResNet50,
        cifar100_model_prefix + "VPTResNet50_vanilla/ckpt_epoch_240.pth"
    ),
